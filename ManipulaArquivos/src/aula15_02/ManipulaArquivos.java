...
public class ManipulaArquivos {
    ...
    public static void main(String[] args) {
        ...
        // instancia objeto para manipular arquivos fisicos na maquina
        ...
        try{
            ...
            objEscritor.println("Adriel Costa");
            objEscritor.println("A.D.R");
            objEscritor.println("Terça, 19/10/2022");
